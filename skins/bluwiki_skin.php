...
$bluwiki_skin_path = 'http://jonnylamb.no-ip.org/~jonny/bongo';
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php $this->text('lang') ?>" lang="<?php $this->text('lang') ?>" dir="<?php $this->text('dir') ?>">
  <head>
    ...
    <style type="text/css" media="screen">/*<![CDATA[*/ @import "<?php $bluwiki_skin_path.$this->text('stylepath') ?>/<?php $this->text('stylename') ?>/main.css"; /*]]>*/</style>
    <link rel="stylesheet" type="text/css" <?php if(empty($this->data['printable']) ) { ?>media="print"<?php } ?> href="<?php $bluwiki_skin_path.$this->text('stylepath') ?>/bluwiki_skin/clean.css" />
  ...
  <body <?php if($this->data['body_ondblclick']) { ?>ondblclick="<?php $this->text('body_ondblclick') ?>"<?php } ?>
	...
	<div id="titleBar">
	<table width="100%" border="0" cellpadding="0" cellspacing="0"><tr width="100%"><td align="left"><a href="index.php"><img src="<?php $this->text('stylepath') ?>/bluwiki_skin/logo.png" border="0"></a></td><td>
